...
defineEmits(['incrementar', 'decrementar', 'agregar-carrito', 'eliminarProducto', 'vaciarCarrito'])
                ...
                <nav class="col-md-6 a mt-5 d-flex align-items-start justify-content-end">
                    ...
                    >
                        ...
                        <div id="carrito" class="bg-white p-3">
                            ...
                            <button @click="$emit('vaciarCarrito')" class="btn btn-dark w-100 mt-3 p-2">Vaciar Carrito</button>
                        </div>
                    </div>
                </nav>
            </div><!--.row-->
